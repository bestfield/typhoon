...
/**
 * Class: SuperMap.Layer.TiandituBorder
 * 天地图服务图层类。
 ...
 */
SuperMap.Layer.TiandituBorder = SuperMap.Class(SuperMap.CanvasLayer, {
  /**
  ...
  url:
    "http://t${num}.tianditu.cn/${type}_${proj}/wmts?service=wmts&request=GetTile" +
    "&version=1.0.0&LAYER=${type}&tileMatrixSet=c&TileMatrix=${z}&TileRow=${y}&TileCol=${x}&style=default&format=tiles",
  ...
  CLASS_NAME: "SuperMap.Layer.TiandituBorder"
});
